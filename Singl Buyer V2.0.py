...
#کص مادر هرکس از کد ها استفاده کنه    
    def show_welcome_message(s):
        push("Power by Singl | @Amiry_11228 | t.me/SinglMod | V:2.0", color=(0, 0.8, 1))
        gs('dingSmall').play()
    ...
    def setup_ui(s):
        ...
        party.PartyWindow.__init__ = new_init#کص مادر هرکس از کد ها استفاده کنه کپي کنه ويرايش کنه ((غيرت لطفا))
#کص مادر هرکس از کد ها استفاده کنه
...
#کص مادر هرکس از کد ها استفاده کنه
    ...
    def show_main_panel(s):
        ...
        w = s.create_window(480, 420, is_main=True)
...
#کص مادر هرکس از کد ها استفاده کنه
        ...
        buttons = [
            ('Item Settings', Call(s.show_item_settings, w), (165, 180)),
            ('Backup & Restore', Call(s.show_backup_restore, w), (165, 130)),
            ('Support', s.open_support, (290, 80)),
            ('Channel', s.open_channel, (40, 80)),
        ]
        #کص مادر هرکس از کد ها استفاده کنه کپي کنه ويرايش کنه ((غيرت لطفا))
#کص مادر هرکس از کد ها استفاده کنه
        ...
        if not s.enabled:
            ...
            status_info = "BEST PERFORMANCE MODE"
            info_color = (1.0, 0.6, 0.0)
        elif s.enabled and s.anti_recoil:
